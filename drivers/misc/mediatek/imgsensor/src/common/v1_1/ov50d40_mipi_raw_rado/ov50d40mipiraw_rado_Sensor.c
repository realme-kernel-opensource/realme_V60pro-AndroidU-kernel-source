...
#include "ov50d40mipiraw_rado_Sensor.h"
#include "ov50d40_Sensor_rado_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_RADO,
    ...
    .custom3 = {
        .pclk = 100000000, /*4080x2296_60.0fps*/
        .linelength = 650,
        .framelength = 2564,
        .startx =0,
        .starty = 0,
    ...
    .custom4 = {
        .pclk = 100000000, /*3264x2448@30fps*/
        .linelength = 850,
        .framelength = 3920,
        .startx = 0,
        .starty = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] = {
	{ 8192,  6144,  16,   0,  8160,  6144,  4080,  3072,  0000,  0000,  4080,  3072,  0,  0,  4080,  3072},	/*Preview*/
	...
	{ 8192,  6144,  16, 776,  8160,  4592,  4080,  2296,  0000,  0000,  4080,  2296,  0,  0,  4080,  2296},	/*custom3 video 60fps*/
    { 8192,  6144, 832, 624,  6528,  4896,  3264,  2448,  0000,  0000,  3264,  2448,  0,  0,  3264,  2448},	/*custom4 DualCam */
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[5] = {
    ...
    /* normal/slim video mode setting */
    {
        ...
        0x01, 0x2B, 0x03E0, 0x023C, 0x03, 0x00, 0x0000, 0x0000 //992x572
    },
    ...
    /* custom4 8M portrait mode setting */
    {
        ...
        0x01, 0x2B, 0x0330, 0x0264, 0x03, 0x00, 0x0000, 0x0000  //816x612
    },
};
...
//imgsensor_pd_info for normal/custom3 video
...
static void write_shutter(kal_uint32 shutter)
{
	...
	if(_is_binning_size) {
		if ((imgsensor.shutter <= imgsensor.frame_length) && (imgsensor.frame_length <= (imgsensor.shutter+3))) {
			imgsensor.frame_length = imgsensor.shutter+4;
			}
	} else {
		if ((imgsensor.shutter <= imgsensor.frame_length) && (imgsensor.frame_length <= (imgsensor.shutter+6))) {
			imgsensor.frame_length = imgsensor.shutter+8;
			}
	}
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == OV50D40_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                pr_info("[get_imgsensor_id] OV50D40 Read sensor id Success, write id:0x%x, driver_id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
