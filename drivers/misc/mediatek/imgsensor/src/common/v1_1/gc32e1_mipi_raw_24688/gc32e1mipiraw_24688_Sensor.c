...
#include "gc32e1mipiraw_24688_Sensor.h"
#include "gc32e1mipi24688_otp.h"
...
#define DEVICE_VERSION_BARLEY_GC32E1    "gc32e1"
static DEFINE_SPINLOCK(imgsensor_drv_lock);


static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC32E1_SENSOR_ID_24688,
	.module_id = 0x01,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	...
	{ 6528, 4896, 0, 0, 6528, 4896, 3264, 2448, 0, 0, 3264, 1836, 0, 0, 3264, 1836}, /* video */
	{ 6528, 4896, 1984, 1728, 2560, 1440, 1280,  720, 0, 0, 1280, 720, 0, 0, 1280, 720}, /* hs video */
...
static void write_shutter(kal_uint32 shutter)
{
	...
	//kal_uint16 c = 0 ,  d = 0, e = 0 ,  f = 0, g = 0,fl1 = 0,fl2 = 0;
	...
	write_cmos_sensor(0x0202, shutter & 0xfffe);
    pr_debug("shutter =%d\n",shutter);
	#else
	if (shutter >= 0xFFFE) {
	...
	#endif
	//c = read_cmos_sensor(0x0202);
	//d = read_cmos_sensor(0x0203);
	//e = read_cmos_sensor(0x021e);
	//f = read_cmos_sensor(0x021d);
	//g = read_cmos_sensor(0x021c);
	//fl1 = read_cmos_sensor(0x0340);
	//fl2 = read_cmos_sensor(0x0341);

	//pr_debug("0x202 = 0x%x , 0x203 = 0x%x , 0x21e = 0x%x , 0x21d = 0x%x , 0x21c = 0x%x\n", c, d, e, f, g);
	//pr_debug("FL1 = %x, FL2 = %x\n", fl1, fl2);
...
kal_uint16 gc32e1_24688_init_addr_data[] = {
	0x0315, 0xc0,
	0x0c10, 0x1b,
	0x01a7, 0x02,
	0x01aa, 0x05,
...
static kal_uint16 gc32e1_fullsize_6528x4896_15fps_addr_data[] = {
	0x031c, 0x60,
	0x0315, 0xd7,
	0x01a9, 0x5d,
	0x0c0c, 0x48,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(gc32e1_24688_init_addr_data,
		sizeof(gc32e1_24688_init_addr_data)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
{
	pr_debug("[%s] custom2_Start, 3264x2448@30.43fps\n", __func__);
	table_write_cmos_sensor(gc32e1_3264x2448_24fps_addr_data,
		sizeof(gc32e1_3264x2448_24fps_addr_data)/sizeof(kal_uint16));
...
{
	pr_debug("[%s] custom3_Start, fullsize 6528x4896@15fps\n", __func__);
	table_write_cmos_sensor(gc32e1_fullsize_6528x4896_15fps_addr_data,
		sizeof(gc32e1_fullsize_6528x4896_15fps_addr_data)/sizeof(kal_uint16));
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			printk("barley_main_gc32e1 get_imgsensor_id : 0x%x,imgsensor_info.sensor_id : 0x%x\n", *sensor_id,imgsensor_info.sensor_id);
			if (*sensor_id == (imgsensor_info.sensor_id - 0x6)) {
				if ((read_gc32e1_avatarl5_eeprom_module(0x00)) == imgsensor_info.module_id) {
					read_gc32e1_version();
					gc32e1_24688_otp_identify();
					if(deviceInfo_register_value == 0x00) {
						register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_BARLEY_GC32E1, imgsensor_info.module_id);
						read_gc32e1_avatarl5_module_data();
						deviceInfo_register_value = 0x01;
						}
				} else {
					*sensor_id = 0xFFFFFFFF;
					printk("barley_main_gc32e1 get_imgsensor_id failed: 0x%x\n", *sensor_id);
					return ERROR_SENSOR_CONNECT_FAIL;
				}
			printk("barley_main_gc32e1 get_imgsensor_id success: 0x%x\n", *sensor_id);
			return ERROR_NONE;
			}
			printk("[barley_main_gc32e1]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
...
static kal_uint32 open(void)
{
	...
	if ((imgsensor_info.sensor_id - 0x6) != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
...
break;
	...
	case SENSOR_FEATURE_GET_4CELL_DATA: /*get 4 cell data from eeprom*/
	{
		...
		if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL)
			gc32e1_24688_copy_crosstalk_data(ct_data);
		break;
	}
