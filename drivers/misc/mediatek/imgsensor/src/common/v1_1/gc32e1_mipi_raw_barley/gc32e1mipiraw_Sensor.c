...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC32E1_SENSOR_ID_BARLEY,
	.module_id = 0x01,
...
kal_uint16 gc32e1_barley_init_addr_data[] = {
	0x0315, 0xc0,
	0x0c10, 0x1b,
	0x01a7, 0x02,
	0x01aa, 0x05,
...
static kal_uint16 gc32e1_normal_video[] = {
	0x031c, 0x60,
	0x0315, 0xd3,
	0x01a9, 0x35,
	0x0c0c, 0x48,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(gc32e1_barley_init_addr_data,
		sizeof(gc32e1_barley_init_addr_data)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(gc32e1_normal_video,
		sizeof(gc32e1_normal_video)/sizeof(kal_uint16));
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == (imgsensor_info.sensor_id - 0x5)) {
...
static kal_uint32 open(void)
{
	...
	if ((imgsensor_info.sensor_id - 0x5) != sensor_id)
		return ERROR_SENSOR_CONNECT_FAIL;
...
break;
	...
	case SENSOR_FEATURE_GET_4CELL_DATA: /*get 4 cell data from eeprom*/
	{
		...
		if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL)
			gc32e1_copy_crosstalk_data(ct_data);
		break;
	}
