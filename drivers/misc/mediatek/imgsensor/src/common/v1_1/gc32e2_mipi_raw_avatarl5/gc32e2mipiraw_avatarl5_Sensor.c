 ...
 * Filename:
 * ---------
 *     gc32e2mipiraw_avatarl5_Sensor.c
 *
 * Project:
 * --------
 *   ALPS
...
#include "gc32e2mipiraw_avatarl5_Sensor.h"
...
#define DEVICE_VERSION_AVATARL5_GC32E2    "gc32e2"
static DEFINE_SPINLOCK(imgsensor_drv_lock);
static kal_uint8 otp_data[0x4000] = {0};

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC32E2_SENSOR_ID_AVATARL5,
    .module_id = 0x01,
    ...
    .custom2 = {//not use for any mode
        ...
        .grabwindow_height = 1836,
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 334400000,//836*4/10
        .max_framerate = 300,
    },
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[9] = {
    ...
    { 6528, 4896, 0, 608, 6528, 3672, 3264, 1836, 0, 0, 3264, 1836, 0, 0, 3264, 1836},/*video */
    ...
    { 6528, 4896, 0, 608, 6528, 3672, 3264, 1836, 0, 0, 3264, 1836, 0, 0, 3264, 1836},  /* custom2 */
    { 6528, 4896, 0, 0, 6528, 4896, 6528, 4896, 0, 0, 6528, 4896, 0, 0, 6528, 4896},  /* custom3 */
    { 6528, 4896, 0, 608, 6528, 3672, 3264, 1836, 0, 0, 3264, 1836, 0, 0, 3264, 1836},  /* custom4 */
};
...
static kal_uint16 gc32e2_3264x2448_24fps_addr_data[] = {
    0x1320, 0x01,
    0x1321, 0x00,
    0x0315, 0x80,
    0x0aaf, 0x00,
...
static void custom1_setting(void)
{
    ...
    table_write_cmos_sensor(gc32e2_3264x2448_24fps_addr_data,
        sizeof(gc32e2_3264x2448_24fps_addr_data)/sizeof(kal_uint16));
...
#define GC32E2_AVATARL5_EEPROM_I2C_ADDR 0xA0
#define GC32E2_ECO_VALUE 3
static BYTE gc32e2_avatarl5_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static kal_uint16 read_gc32e2_avatarl5_eeprom_module(kal_uint32 addr)
{
    kal_uint16 get_byte = 0;
    char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

    iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, GC32E2_AVATARL5_EEPROM_I2C_ADDR);

    return get_byte;
}

static void read_gc32e2_avatarl5_module_data()
{
    kal_uint16 idx = 0;
    ...
    memset(gc32e2_avatarl5_common_data, 0,sizeof(gc32e2_avatarl5_common_data));
    // QR
    for(idx = 0; idx < sn_length; idx++)
    {
        gc32e2_avatarl5_common_data[8 + idx] = read_gc32e2_avatarl5_eeprom_module(sn_starAddr + idx);
    }
    // vcm
    gc32e2_avatarl5_common_data[40] = read_gc32e2_avatarl5_eeprom_module(vcmAddr);
    gc32e2_avatarl5_common_data[41] = read_gc32e2_avatarl5_eeprom_module(vcmAddr + 1);
     // lensid
    gc32e2_avatarl5_common_data[44] = read_gc32e2_avatarl5_eeprom_module(lensAddr);
    gc32e2_avatarl5_common_data[45] = read_gc32e2_avatarl5_eeprom_module(lensAddr + 1);
    // macro
    gc32e2_avatarl5_common_data[48] = read_gc32e2_avatarl5_eeprom_module(macAddr_lsb);
    gc32e2_avatarl5_common_data[49] = read_gc32e2_avatarl5_eeprom_module(macAddr_msb);
    // inf
    gc32e2_avatarl5_common_data[52] = read_gc32e2_avatarl5_eeprom_module(infAddr_lsb);
    gc32e2_avatarl5_common_data[53] = read_gc32e2_avatarl5_eeprom_module(infAddr_msb);

    for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
        printk("cam data: %02x %02x %02x %02x\n",
               gc32e2_avatarl5_common_data[idx],
               gc32e2_avatarl5_common_data[idx + 1],
               gc32e2_avatarl5_common_data[idx + 2],
               gc32e2_avatarl5_common_data[idx + 3]);
}
...
static kal_uint32 read_gc32e2_version(void)
{
      kal_uint32 gc32e2_version_value = 0;
      ...
      gc32e2_version_value = read_cmos_sensor_m(0x0e);
      printk("read gc32e2 version 0x0e = %d\n", gc32e2_version_value);
      return gc32e2_version_value;
}
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                if ((read_gc32e2_avatarl5_eeprom_module(0x00)) == imgsensor_info.module_id) {
                    read_gc32e2_version();
                    if(deviceInfo_register_value == 0x00) {
                        register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_AVATARL5_GC32E2, imgsensor_info.module_id);
                        read_gc32e2_avatarl5_module_data();
                        if(otp_data[0] == 0) {
                    ...
                    *sensor_id = 0xFFFFFFFF;
                    printk("gc32e2_camera_sensor get_imgsensor_id failed: 0x%x\n", *sensor_id);
                    return ERROR_SENSOR_CONNECT_FAIL;
                }
            printk("gc32e2_camera_sensor get_imgsensor_id success: 0x%x\n", *sensor_id);
            return ERROR_NONE;
            }
...
/*************************PDAF END*************************/
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        memcpy(feature_return_para_32, gc32e2_avatarl5_common_data,
