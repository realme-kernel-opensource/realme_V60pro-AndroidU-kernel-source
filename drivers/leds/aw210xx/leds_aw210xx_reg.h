...
static  AW_MULTI_BREATH_DATA_STRUCT charge_effect_data1[] = {
	//effect1:moving
	{{400, 200, 600, 200,0, 600}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{600, 200, 200, 200,0, 800}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{600, 200, 200, 200,0, 800}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{400, 200, 600, 200,0, 600}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{200, 200, 1000, 200,0, 400}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{0, 200, 1400, 200,0, 200}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{0, 200, 1400, 200,0, 200}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{200, 200, 1000, 200,0, 400}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	
	//effect2:moving
	{{400, 200, 800, 200,0, 400}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{600, 200, 800, 200,0,200}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{600, 200, 800, 200,0, 200}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{400, 200, 800, 200,0, 400}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{200, 200, 800, 200,0, 600}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{0, 200, 800, 200,0, 800}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{0, 200, 800, 200,0, 800}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
	{{200, 200, 800, 200,0, 600}, 1, 1, rgb_green_list, br_green_fadeh, br_fadel},
};
...
static  AW_MULTI_BREATH_DATA_STRUCT incall_effect_data1[] = {	
	//effect2:moving
	{{400, 200, 800, 200,0, 400}, 1, 1, rgb_incall_list, br_incall_fadeh, br_fadel},
	{{600, 200, 800, 200,0,200}, 1, 1, rgb_incall_list, br_incall_fadeh, br_fadel},
	{{600, 200, 800, 200,0, 200}, 1, 1, rgb_incall_list, br_incall_fadeh, br_fadel},
	{{400, 200, 800, 200,0, 400}, 1, 1, rgb_incall_list, br_incall_fadeh, br_fadel},
	{{200, 200, 800, 200,0, 600}, 1, 1, rgb_incall_list, br_incall_fadeh, br_fadel},
	{{0, 200, 800, 200,0, 800}, 1, 1, rgb_incall_list, br_incall_fadeh, br_fadel},
	{{0, 200, 800, 200,0, 800}, 1, 1, rgb_incall_list, br_incall_fadeh, br_fadel},
	{{200, 200, 800, 200,0, 600}, 1, 1, rgb_incall_list, br_incall_fadeh, br_fadel},
...
static  AW_MULTI_BREATH_DATA_STRUCT poweron_effect_data1[] = {
	{{400, 200, 600, 200,600, 1000}, 2, 1, rgb_poweron_list, br_poweron_fadeh, br_fadel},
	{{600, 200, 600, 200,600, 800}, 2, 1, rgb_poweron_list, br_poweron_fadeh, br_fadel},
	{{800, 200, 600, 200,600, 600}, 2, 1, rgb_poweron_list, br_poweron_fadeh, br_fadel},
	{{1000, 200, 600, 200,600, 400}, 2, 1, rgb_poweron_list, br_poweron_fadeh, br_fadel},
	{{1200, 200, 600, 200,600, 200}, 2, 1, rgb_poweron_list, br_poweron_fadeh, br_fadel},
	{{1400, 200, 600, 200,600, 0}, 2, 1, rgb_poweron_list, br_poweron_fadeh, br_fadel},
	{{0, 200, 600, 200,600, 1400}, 2, 1, rgb_poweron_list, br_poweron_fadeh, br_fadel},
	{{200, 200, 600, 200,600, 1200}, 2, 1, rgb_poweron_list, br_poweron_fadeh, br_fadel},
};

static  AW_MULTI_BREATH_DATA_STRUCT notify_effect_data1[] = {
	{{0, 200, 400, 200,200, 0}, 5, 1, rgb_notify_list, br_notify_fadeh, br_fadel},
	{{0, 200, 400, 200,200, 0}, 5, 1, rgb_notify_list, br_notify_fadeh, br_fadel},
	{{0, 200, 400, 200,200, 0}, 5, 1, rgb_notify_list, br_notify_fadeh, br_fadel},
	{{0, 200, 400, 200,200, 0}, 5, 1, rgb_notify_list, br_notify_fadeh, br_fadel},
	{{0, 200, 400, 200,200, 0}, 5, 1, rgb_notify_list, br_notify_fadeh, br_fadel},
...
static  AW_MULTI_BREATH_DATA_STRUCT gameenter_effect_data1[] = {
	{{0, 0, 80, 0,0, 80}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	{{0, 0, 80, 0,0, 80}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	{{0, 0, 80, 0,0, 80}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	{{0, 0, 80, 0,0, 80}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	{{0, 0, 80, 0,0, 80}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	...
	{{40, 20, 60, 20,60, 100}, 5, sizeof(rgb_multi_game_lap)/sizeof(AW_COLOR_STRUCT), rgb_multi_game_lap, br_game_fadeh, br_fadel},
	{{60, 20, 60, 20,60, 80}, 5, sizeof(rgb_multi_game_lap)/sizeof(AW_COLOR_STRUCT), rgb_multi_game_lap, br_game_fadeh, br_fadel},
	{{80, 20, 60, 20,60, 60}, 5, sizeof(rgb_multi_game_lap)/sizeof(AW_COLOR_STRUCT), rgb_multi_game_lap, br_game_fadeh, br_fadel},
	{{100, 20, 60, 20,60, 40}, 5, sizeof(rgb_multi_game_lap)/sizeof(AW_COLOR_STRUCT), rgb_multi_game_lap, br_game_fadeh, br_fadel},
	{{120, 20, 60, 20,60, 20}, 5, sizeof(rgb_multi_game_lap)/sizeof(AW_COLOR_STRUCT), rgb_multi_game_lap, br_game_fadeh, br_fadel},
	{{140, 20, 60, 20,60, 0}, 5, sizeof(rgb_multi_game_lap)/sizeof(AW_COLOR_STRUCT), rgb_multi_game_lap, br_game_fadeh, br_fadel},
	{{0, 20, 60, 20,60, 140}, 5, sizeof(rgb_multi_game_lap)/sizeof(AW_COLOR_STRUCT), rgb_multi_game_lap, br_game_fadeh, br_fadel},
	{{20, 20, 60, 20,60, 120}, 5, sizeof(rgb_multi_game_lap)/sizeof(AW_COLOR_STRUCT), rgb_multi_game_lap, br_game_fadeh, br_fadel},	
	
	{{0, 0, 80, 0,0, 40}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	{{0, 0, 80, 0,0, 40}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	{{0, 0, 80, 0,0, 40}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	{{0, 0, 80, 0,0, 40}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	{{0, 0, 80, 0,0, 40}, 8, 9, rgb_multi_game_racing, br_game_fadeh, br_fadel},
	...
	{{0, 30, 60, 30, 30, 0}, 3, 1, &rgb_multi_game_racing[0], br_game_fadeh, br_fadel},
	{{0, 30, 60, 30, 30, 0}, 3, 1, &rgb_multi_game_racing[1], br_game_fadeh, br_fadel},
	{{0, 30, 60, 30, 30, 0}, 3, 1, &rgb_multi_game_racing[2], br_game_fadeh, br_fadel},
	{{0, 30, 60, 30, 30, 0}, 3, 1, &rgb_multi_game_racing[3], br_game_fadeh, br_fadel},
	{{0, 30, 60, 30, 30, 0}, 3, 1, &rgb_multi_game_racing[4], br_game_fadeh, br_fadel},
	{{0, 30, 60, 30, 30, 0}, 3, 1, &rgb_multi_game_racing[5], br_game_fadeh, br_fadel},
	{{0, 30, 60, 30, 30, 0}, 3, 1, &rgb_multi_game_racing[6], br_game_fadeh, br_fadel},
	{{0, 30, 60, 30, 30, 0}, 3, 1, &rgb_multi_game_racing[7], br_game_fadeh, br_fadel},
};

int charge_color[][9] ={  //last value is brightness
	{ 0,0,0,255,0,0,255,0,180},
	{ 0,0,255,255,0,0,255,255,180},
	{ 255,0,255,255,0,255,255,255,180},
