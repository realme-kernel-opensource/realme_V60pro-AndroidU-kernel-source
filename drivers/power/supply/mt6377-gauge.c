 ...
 * Author Timo Liao<timo.liao@mediatek.com>
 */
...
#define RG_FGADC_CON3				0xd0a
#define FG_SW_CLEAR_MASK			BIT(3)
#define FG_SW_READ_PRE_MASK			BIT(0)
#define RG_FGADC_RST_CON0			0xd11
#define FG_RSTB_STATUS_MASK			BIT(0)
#define FG_RSTB_STATUS_SHIFT			0
#define RG_FGADC_CAR_CON0			0xd12
#define RG_FGADC_CAR_CON1			0xd14
#define RG_FGADC_CARTH_CON0			0xd16
#define RG_FGADC_CARTH_CON1			0xd18
#define RG_FGADC_CARTH_CON2			0xd1a
#define RG_FGADC_CARTH_CON3			0xd1c
#define RG_FGADC_NCAR_CON0			0xd1e
#define RG_FGADC_NCAR_CON1			0xd20
#define RG_FGADC_NCAR_CON2			0xd22
#define RG_FGADC_NCAR_CON3			0xd24
#define FG_N_CHARGE_TH_MASK			GENMASK(15, 0)
#define RG_FGADC_IAVG_CON0			0xd26
#define FG_IAVG_15_00_MASK			GENMASK(15, 0)
#define RG_FGADC_IAVG_CON1			0xd28
#define FG_IAVG_VLD_MASK			BIT(0)
#define RG_FGADC_IAVG_CON2			0xd29
#define FG_IAVG_27_16_MASK			GENMASK(11, 0)
#define RG_FGADC_IAVG_CON3			0xd2b
#define RG_FGADC_IAVG_CON5			0xd2f
#define RG_FGADC_NTER_CON0			0xd33
#define RG_FGADC_NTER_CON1			0xd35
#define FGADC_NTER_MASK				GENMASK(29, 0)
#define RG_FGADC_ZCV_CON0			0xd48
#define FG_ZCV_DET_IV_MASK			GENMASK(3, 0)
#define FG_ZCV_DET_IV_SHIFT			0
#define RG_FGADC_ZCV_CON2			0xd4a
#define RG_FGADC_ZCVTH_CON0			0xd50
#define RG_FGADC_ZCVTH_CON1			0xd52
#define FG_ZCV_CAR_TH_MASK_L			GENMASK(15, 0)
#define FG_ZCV_CAR_TH_MASK_H			GENMASK(14, 0)
#define RG_FGADC_R_CON0				0xd87
#define RG_FGADC_CUR_CON0			0xd89
#define RG_FGADC_CUR_CON3			0xd8f
#define RG_FGADC_GAIN_CON0_L			0xd95
#define RG_FGADC_GAIN_CON0_H			0xd96
#define RG_SYSTEM_INFO_CON0			0xd98

#define RG_HK_TOP_STRUP_CON1			0xfaa
#define HK_STRUP_AUXADC_START_SEL_MASK		BIT(2)
#define HK_STRUP_AUXADC_START_SEL_SHIFT		2
#define RG_BATON_ANA_MON0			0xe08
#define AD_BATON_UNDET_MASK			BIT(1)

#define RG_AUXADC_ADC_OUT_PWRON_PCHR		0x10aa
#define AUXADC_ADC_RDY_PWRON_PCHR_MASK		BIT(15)
#define AUXADC_ADC_OUT_PWRON_PCHR_MASK		GENMASK(14, 0)

#define RG_AUXADC_ADC_OUT_FGADC_PCHR		0x10b6
#define AUXADC_ADC_OUT_FGADC_PCHR_MASK		GENMASK(14, 0)
#define RG_AUXADC_ADC_OUT_BAT_PLUGIN_PCHR	0x10b8
...
#define RG_AUXADC_LBAT2_0			0x1219
#define AUXADC_LBAT2_EN_MASK			BIT(0)
#define RG_AUXADC_LBAT2_1			0x121a
...
#define RG_AUXADC_LBAT2_2			0x121b
...
#define RG_AUXADC_LBAT2_3			0x121c
#define AUXADC_LBAT2_VOLT_MAX_MASK		GENMASK(11, 0)
#define RG_AUXADC_LBAT2_5			0x121e
...
#define RG_AUXADC_LBAT2_6			0x121f
#define AUXADC_LBAT2_VOLT_MIN_MASK		GENMASK(11, 0)


#define RG_AUXADC_BAT_TEMP_0			0x1225
#define AUXADC_BAT_TEMP_EN_MASK			BIT(0)
#define RG_AUXADC_BAT_TEMP_1			0x1226
#define AUXADC_BAT_TEMP_FROZE_EN_MASK		BIT(0)
#define RG_AUXADC_BAT_TEMP_2			0x1227
...
#define RG_AUXADC_NAG_1				0x1248
#define AUXADC_NAG_ZCV_MASK			GENMASK(14, 0)
#define RG_AUXADC_NAG_3				0x124a
#define RG_AUXADC_NAG_5				0x124c
#define AUXADC_NAG_C_DLTV_TH_MASK_L		GENMASK(15, 0)
#define AUXADC_NAG_C_DLTV_TH_MASK_H		GENMASK(26, 16)
#define RG_AUXADC_NAG_7				0x124e
#define RG_AUXADC_NAG_9				0x1250
#define AUXADC_NAG_CNT_MASK			GENMASK(25, 0)
#define RG_AUXADC_NAG_11			0x1252
#define RG_AUXADC_NAG_13			0x1254
#define RG_AUXADC_NAG_15			0x1256
...
extern int oplus_chg_get_is_gauge_ready(void);
...
static struct mt6377_priv st_mt6377_priv;
...
{
	u16 regval, regval_ori;
	int ret;

	ret = regmap_raw_read(gauge->regmap, RG_SYSTEM_INFO_CON0, &regval, sizeof(regval));

	regval_ori = regval;
	bm_debug("[%s]info:%d v:%d, ori:0x%x\n", __func__, ginfo, value, regval);
	...
	ret = regmap_raw_write(gauge->regmap, RG_SYSTEM_INFO_CON0,
		&regval, sizeof(regval));

	bm_debug("[%s]info:%d v:%d, ori:0x%x:after:0x%x\n",
		__func__, ginfo, value, regval_ori, regval);
	...
	enum gauge_property ginfo, int *value)
{
	...
	ret = regmap_raw_read(gauge->regmap, RG_SYSTEM_INFO_CON0,
		&regval, sizeof(regval));
	...
	int _prd, int _zcv_mv, int _thr_mv)
{
	...
	u16 NAG_C_DLTV_Threashold_l = 0, NAG_C_DLTV_Threashold_h = 0;
	int period = 0;
	u16 regval = 0;
	...
	regmap_raw_write(gauge->regmap,
		RG_AUXADC_NAG_1,
		&regval,
		sizeof(regval));

	NAG_C_DLTV_Threashold_l = gauge->thr_reg & AUXADC_NAG_C_DLTV_TH_MASK_L;
	NAG_C_DLTV_Threashold_h = (gauge->thr_reg & AUXADC_NAG_C_DLTV_TH_MASK_H) >> 16;

	regmap_raw_write(gauge->regmap,
		RG_AUXADC_NAG_3,
		&NAG_C_DLTV_Threashold_l,
		sizeof(NAG_C_DLTV_Threashold_l));

	regmap_raw_write(gauge->regmap,
		RG_AUXADC_NAG_5,
		&NAG_C_DLTV_Threashold_h,
		sizeof(NAG_C_DLTV_Threashold_h));
	...
	bm_debug("[fg_bat_nafg][fgauge_set_nafg_interrupt_internal] time[%d] zcv[%d:%d] thr[%d:%d] 26_0[0x%x 0x%x]\n",
		_prd, _zcv_mv, gauge->zcv_reg, _thr_mv,
		gauge->thr_reg,
		NAG_C_DLTV_Threashold_h, NAG_C_DLTV_Threashold_l);
...
static int get_nafg_vbat(struct mtk_gauge *gauge)
{
	...
	do {
		regmap_raw_read(gauge->regmap, RG_AUXADC_ADC_OUT_NAG,
	...
	int fg_zcv_car_th)
{
	...
	u16 fg_zcv_car_th_regval_l = 0, fg_zcv_car_th_regval_h = 0;
	...
	fg_zcv_car_th_regval_l = fg_zcv_car_th_reg & FG_ZCV_CAR_TH_MASK_L;
	regmap_raw_write(gauge_dev->regmap, RG_FGADC_ZCVTH_CON0, &fg_zcv_car_th_regval_l,
			 sizeof(fg_zcv_car_th_regval_l));

	fg_zcv_car_th_regval_h = (fg_zcv_car_th_reg >> 16) & FG_ZCV_CAR_TH_MASK_H;
	regmap_raw_write(gauge_dev->regmap, RG_FGADC_ZCVTH_CON1, &fg_zcv_car_th_regval_h,
			 sizeof(fg_zcv_car_th_regval_h));

	bm_debug("[FG_ZCV_INT][%s] det_time %d mv %d reg %lld 30_00 0x%x %x\n",
		__func__, fg_zcv_det_time, fg_zcv_car_th, fg_zcv_car_th_reg,
		fg_zcv_car_th_regval_h, fg_zcv_car_th_regval_l);
...
int nafg_check_corner(struct mtk_gauge *gauge)
{
	...
	u16 nag_c_dltv_value_l = 0, nag_c_dltv_value_h = 0;
	...
	/*AUXADC_NAG_7*/
	regmap_raw_read(gauge->regmap, RG_AUXADC_NAG_13, &nag_c_dltv_value_l,
			sizeof(nag_c_dltv_value_l));
	regmap_raw_read(gauge->regmap, RG_AUXADC_NAG_15, &nag_c_dltv_value_h,
			sizeof(nag_c_dltv_value_h));

	nag_c_dltv_value = nag_c_dltv_value_h;
	nag_c_dltv_value = nag_c_dltv_value << 16;
	nag_c_dltv_value |= nag_c_dltv_value_l;
...
/*From: meidatek Subject: [PATCH] [ALPS08743825]*/
	...
	struct mtk_gauge_sysfs_field_info *attr, int en)
{
	if (en == 0) {
		...
		regmap_update_bits(gauge->regmap, RG_AUXADC_BAT_TEMP_0,
	...
	struct mtk_gauge_sysfs_field_info *attr, int threshold)
{
	...
	regval_l = carReg & FG_N_CHARGE_TH_MASK;
	regmap_raw_write(gauge->regmap, RG_FGADC_NCAR_CON2, &regval_l, sizeof(regval_l));
	regval_h = (carReg >> 16) & FG_N_CHARGE_TH_MASK;
	regmap_raw_write(gauge->regmap, RG_FGADC_NCAR_CON3, &regval_h, sizeof(regval_h));

	bm_err("car:%d carR:%lld r:%lld, regval:%x %x\n",
		threshold, car, carReg, regval_h, regval_l);
...
int fgauge_get_time(struct mtk_gauge *gauge_dev, unsigned int *ptime)
{
	...
	long long time = 0;
	u32 time_regval = 0;
	u16 time_regval_l = 0, time_regval_h = 0;

	pre_gauge_update(gauge_dev);

	regmap_raw_read(
		gauge_dev->regmap, RG_FGADC_NTER_CON0, &time_regval_l, sizeof(time_regval_l));
	regmap_raw_read(
		gauge_dev->regmap, RG_FGADC_NTER_CON1, &time_regval_h, sizeof(time_regval_h));

	time_regval = time_regval_h;
	time_regval = time_regval << 16;
	time_regval |= time_regval_l;
...
void read_fg_hw_info_ncar(struct mtk_gauge *gauge_dev)
{
	...
	u16 temp_NCAR_l = 0, temp_NCAR_h = 0;
	u32 temp_NCAR = 0;
	signed int dvalue_NCAR = 0;
	long long Temp_Value = 0;

	regmap_raw_read(gauge_dev->regmap, RG_FGADC_NCAR_CON0, &temp_NCAR_l, sizeof(temp_NCAR_l));
	regmap_raw_read(gauge_dev->regmap, RG_FGADC_NCAR_CON1, &temp_NCAR_h, sizeof(temp_NCAR_h));

	temp_NCAR = temp_NCAR_h;
	temp_NCAR = temp_NCAR_h << 16;
	temp_NCAR |= temp_NCAR_l;
	bm_err("[%s]l:0x%x h:0x%x, ncar:0x%x\n",
		__func__, temp_NCAR_l, temp_NCAR_h, temp_NCAR);
	...
	struct mtk_gauge_sysfs_field_info *attr, int *val)
{
	...
	regmap_raw_read(gauge->regmap, RG_FGADC_CAR_CON0, &temp_car_l, sizeof(temp_car_l));
	regmap_raw_read(gauge->regmap, RG_FGADC_CAR_CON1, &temp_car_h, sizeof(temp_car_h));
...
static int get_ptim_current(struct mtk_gauge *gauge)
{
	...
	/* Auto adjust value */
	if (r_fg_value != DEFAULT_R_FG && r_fg_value != 0)
...
static int read_hw_ocv_6377_plug_in(struct mtk_gauge *gauge)
{
	...
	if (adc_rdy == 1) {
		regmap_update_bits(gauge->regmap, RG_AUXADC_CON16,
...
static int read_hw_ocv_6377_power_on(struct mtk_gauge *gauge)
{
	...
	if (adc_result_rdy == 1) {
		regmap_update_bits(gauge->regmap, RG_AUXADC_CON16, AUXADC_ADC_RDY_PWRON_CLR_MASK,
...
static int read_hw_ocv_6377_power_on_rdy(struct mtk_gauge *gauge)
{
	int pon_rdy = 0;
	u16 regval = 0;
...
{
	u16 NAG_C_DLTV_CNT_L = 0, NAG_C_DLTV_CNT_H = 0;
	u32 NAG_C_DLTV_CNT = 0;

	regmap_raw_read(
		gauge->regmap, RG_AUXADC_NAG_7, &NAG_C_DLTV_CNT_L, sizeof(NAG_C_DLTV_CNT_L));
	regmap_raw_read(
		gauge->regmap, RG_AUXADC_NAG_9, &NAG_C_DLTV_CNT_H, sizeof(NAG_C_DLTV_CNT_H));

	NAG_C_DLTV_CNT = NAG_C_DLTV_CNT_H;
	NAG_C_DLTV_CNT = NAG_C_DLTV_CNT << 16;
	NAG_C_DLTV_CNT |= NAG_C_DLTV_CNT_L;
	...
	struct mtk_gauge_sysfs_field_info *attr, int *nafg_c_dltv)
{
	...
	bool bcheckbit10;
	u16 nag_c_dltv_l = 0, nag_c_dltv_h = 0;
	u32 nag_c_dltv_regval = 0;

	regmap_raw_read(gauge->regmap, RG_AUXADC_NAG_13, &nag_c_dltv_l,
			sizeof(nag_c_dltv_l));
	regmap_raw_read(gauge->regmap, RG_AUXADC_NAG_15, &nag_c_dltv_h,
			sizeof(nag_c_dltv_h));

	nag_c_dltv_regval = nag_c_dltv_h;
	nag_c_dltv_regval = nag_c_dltv_regval << 16;
	nag_c_dltv_regval |= nag_c_dltv_l;
	...
	struct mtk_gauge_sysfs_field_info *attr, int *val)
{
	...
	int _hw_ocv_63_pon;
	int _hw_ocv_63_plugin;
	int _hw_ocv_63_pon_rdy;
	int _hw_ocv_chgin;
	...
	_hw_ocv_63_pon_rdy = read_hw_ocv_6377_power_on_rdy(gauge_dev);
	_hw_ocv_63_pon = read_hw_ocv_6377_power_on(gauge_dev);
	_hw_ocv_63_plugin = read_hw_ocv_6377_plug_in(gauge_dev);
	...
	if (fg_is_charger_exist) {
		_hw_ocv_rdy = _hw_ocv_63_pon_rdy;
		if (_hw_ocv_rdy == 1) {
	...
	*val = _hw_ocv;
	...
	zcvinfo->pmic_rdy = _hw_ocv_63_pon_rdy;
	zcvinfo->pmic_zcv = _hw_ocv_63_pon;
	zcvinfo->pmic_in_zcv = _hw_ocv_63_plugin;
	...
	gauge_dev->fg_hw_info.pmic_zcv = _hw_ocv_63_pon;
	gauge_dev->fg_hw_info.pmic_zcv_rdy = _hw_ocv_63_pon_rdy;
	...
	bm_err("[%s] _hw_ocv_63_pon_rdy %d _hw_ocv_63_pon %d _hw_ocv_63_plugin %d _hw_ocv_chgin %d _sw_ocv %d now_temp %d now_thr %d\n",
		__func__, _hw_ocv_63_pon_rdy, _hw_ocv_63_pon,
		_hw_ocv_63_plugin, _hw_ocv_chgin, _sw_ocv,
		now_temp, now_thr);
	...
	struct mtk_gauge_sysfs_field_info *attr, int *val)
{
	...
	*val = !regval ? 1 : 0;
	...
	if (regval) {
		ret = regmap_update_bits(gauge->regmap, RG_AUXADC_CON16,
			AUXADC_ADC_RDY_PWRON_CLR_MASK,
			AUXADC_ADC_RDY_PWRON_CLR_MASK);
	...
	struct mtk_gauge_sysfs_field_info *attr, int threshold)
{
	...
	bm_err("[fg_set_vbat2_l_th] thr_mv:%d [0x%x det_time:%d %d det_counter:%d %d]\n",
		threshold,
		vbat2_l_th_reg,
		gauge->hw_status.vbat2_det_time, vbat2_det_time,
		gauge->hw_status.vbat2_det_counter, vbat2_det_counter);
...
static struct mtk_gauge_sysfs_field_info mt6377_sysfs_field_tbl[] = {
...
static struct attribute *
	mt6377_sysfs_attrs[ARRAY_SIZE(mt6377_sysfs_field_tbl) + 1];

static const struct attribute_group mt6377_sysfs_attr_group = {
	.attrs = mt6377_sysfs_attrs,
};

static void mt6377_sysfs_init_attrs(void)
{
	int i, limit = ARRAY_SIZE(mt6377_sysfs_field_tbl);

	for (i = 0; i < limit; i++)
		mt6377_sysfs_attrs[i] = &mt6377_sysfs_field_tbl[i].attr.attr;

	mt6377_sysfs_attrs[limit] = NULL; /* Has additional entry for this */
}

static int mt6377_sysfs_create_group(struct mtk_gauge *gauge)
{
	mt6377_sysfs_init_attrs();

	return sysfs_create_group(&gauge->psy->dev.kobj,
			&mt6377_sysfs_attr_group);
}

static void mt6377_gauge_shutdown(struct platform_device *pdev)
{
	struct mtk_battery *gm;
	struct mtk_gauge *gauge;
...
static int mt6377_gauge_suspend(struct platform_device *pdev,
	pm_message_t state)
{
	struct mtk_battery *gm;
	struct mtk_gauge *gauge;
...
static int mt6377_gauge_resume(struct platform_device *pdev)
{
	struct mtk_battery *gm;
	struct mtk_gauge *gauge;
	...
	struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	struct mtk_battery *gm;
#ifdef OPLUS_FEATURE_CHG_BASIC
	int fakeoff_out_data[6] = {0, 0, 0, 0, 0, 1};
#endif
	...
	case Get_FakeOff_Param:
		if(for_kpoc_logo_show) {
			...
			if (oplus_is_vooc_project()) {
				...
				fakeoff_out_data[5] = (oplus_chg_get_is_gauge_ready() == true ? 1: 0);
			} else {
				if (gm->init_flag == 1)
...
static int mtk_gauge_proprietary_init(struct mt6377_priv *priv)
{
	priv->default_r_fg = DEFAULT_R_FG;
...
static void mt6377_gauge_refactor_unit(struct mt6377_priv *priv)
{
	...
	pr_notice("%s:20A:%d,r_fg:%d,UNIT_MULTIPLE:%d,unit_fg_current:%d,unit_charge:%d,unit_fg_iavg:%d,unit_fgcar_zcv:%d\n",
		  __func__,
		  priv->gauge->gm->fg_cust_data.curr_measure_20a,
		  priv->default_r_fg,
		  fg_cust_data.unit_multiple,
		  priv->unit_fgcurrent,
		  priv->unit_charge,
		  priv->unit_fg_iavg,
		  priv->unit_fgcar_zcv);
...
static int mt6377_gauge_probe(struct platform_device *pdev)
{
	struct mt6377_priv *priv = &st_mt6377_priv;
	struct mtk_gauge *gauge;
	int ret = 0;
	...
	mt6377_sysfs_create_group(gauge);
	...
	mt6377_gauge_refactor_unit(priv);

#ifdef OPLUS_FEATURE_CHG_BASIC
	/* kernel power off charging logo show */
	of_property_read_u32(pdev->dev.of_node, "FOR_KPOC_LOGO_SHOW", &(for_kpoc_logo_show));
	bm_err("%s, for_kpoc_logo_show:%d\n", __func__, for_kpoc_logo_show);
#endif

	bm_err("%s:initial done %d\n", __func__, ret);

	return 0;
}

static const struct of_device_id mt6377_gauge_of_match[] = {
	{.compatible = "mediatek,mt6377-gauge",},
	{},
};

static int mt6377_gauge_remove(struct platform_device *pdev)
{
...
MODULE_DEVICE_TABLE(of, mt6377_gauge_of_match);

static struct platform_driver mt6377_gauge_driver = {
	.probe = mt6377_gauge_probe,
	.remove = mt6377_gauge_remove,
	.shutdown = mt6377_gauge_shutdown,
	.suspend = mt6377_gauge_suspend,
	.resume = mt6377_gauge_resume,
	.driver = {
		.name = "mt6377_gauge",
		.of_match_table = mt6377_gauge_of_match,
		},
};

static int __init mt6377_gauge_init(void)
{
	return platform_driver_register(&mt6377_gauge_driver);
}
module_init(mt6377_gauge_init);

static void __exit mt6377_gauge_exit(void)
{
	platform_driver_unregister(&mt6377_gauge_driver);
}
module_exit(mt6377_gauge_exit);
