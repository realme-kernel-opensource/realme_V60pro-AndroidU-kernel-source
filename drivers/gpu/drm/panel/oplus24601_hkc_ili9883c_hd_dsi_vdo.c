 ...
 ** OPLUS_EDIT
 ** File: oplus24601_hkc_ili9883c_hd_dsi_vdo.h
...
#endif
#include "oplus24601_hkc_ili9883c_hd_dsi_vdo.h"
...
static void jdi_panel_init(struct jdi *ctx)
{
        ...
        jdi_dcs_write_seq_static(ctx, 0x08, 0x8A);
        jdi_dcs_write_seq_static(ctx, 0x09, 0x05);
        jdi_dcs_write_seq_static(ctx, 0x0A, 0xB5);
        jdi_dcs_write_seq_static(ctx, 0x0B, 0x00);

        jdi_dcs_write_seq_static(ctx, 0x0C, 0x26);
        jdi_dcs_write_seq_static(ctx, 0x0D, 0x26);
        jdi_dcs_write_seq_static(ctx, 0x0E, 0x00);
        jdi_dcs_write_seq_static(ctx, 0x0F, 0x00);

        jdi_dcs_write_seq_static(ctx, 0x16, 0x8A);
        jdi_dcs_write_seq_static(ctx, 0x17, 0x05);
        jdi_dcs_write_seq_static(ctx, 0x18, 0x35);
        jdi_dcs_write_seq_static(ctx, 0x19, 0x00);

        jdi_dcs_write_seq_static(ctx, 0x1A, 0x26);
        jdi_dcs_write_seq_static(ctx, 0x1B, 0x26);
        ...
        jdi_dcs_write_seq_static(ctx, 0xCB, 0xAB);
        jdi_dcs_write_seq_static(ctx, 0xCC, 0xA2);
...
static void cabc_mode_retore(struct jdi *ctx)
{
	...
	if (cabc_mode_backup == 1) {
		...
		jdi_dcs_write_seq_static(ctx, 0xFF, 0x98, 0x83, 0x00);
		jdi_dcs_write_seq_static(ctx, 0xB8, 0x94);
		jdi_dcs_write_seq_static(ctx, 0xFF, 0x98, 0x83, 0x00);
...
static struct mtk_panel_params ext_params_50hz = {
                .pll_clk = PLL_CLOCK,
                .vendor = "ili9883c_rado",
                .manufacture = "24601_hkc_ili9883c",
                .cust_esd_check = 1,
                .esd_check_enable = 1,
                ...
                .lcm_esd_check_table[2] = {
                        .cmd = 0x09, .count = 4, .para_list[0] = 0x80, .para_list[1] = 0x03, .para_list[2] = 0x06, .para_list[3] = 0x00,
                },
                .ssc_enable = 0,
                .bdg_ssc_enable = 0,
                .lane_swap_en = 0,
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "ili9883c_rado", "24601_hkc_ili9883c");
...
static const struct of_device_id jdi_of_match[] = {
        {
                .compatible = "oplus24601,hkc,ili9883c,hd,dsi,vdo",
        },
        {
        }
};
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "oplus24601_hkc_ili9883c_hd_dsi_vdo",
                .owner = THIS_MODULE,
