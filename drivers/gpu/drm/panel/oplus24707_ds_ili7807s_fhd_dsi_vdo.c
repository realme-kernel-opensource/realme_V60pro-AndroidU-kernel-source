...
#endif
#include "oplus24707_ds_ili7807s_fhd_dsi_vdo.h"
...
static void cabc_mode_retore(struct jdi *ctx)
{
	...
	if (cabc_mode_backup == 1) {
		...
		jdi_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x07, 0x03);
		jdi_dcs_write_seq_static(ctx, 0xB8, 0x05);
		jdi_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x07, 0x00);
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "ili7807s_rado", "24707_ds_ili7807s");
...
static const struct of_device_id jdi_of_match[] = {
        {
                .compatible = "oplus24707,ds,ili7807s,fhd,dsi,vdo",
        },
        {
        }
};
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "oplus24707_ds_ili7807s_fhd_dsi_vdo",
                .owner = THIS_MODULE,
