 ...
 ** OPLUS_EDIT
 ** File: oplus24601_djn_icnl9916ac_hd_dsi_vdo.h
...
#endif
#include "oplus24601_djn_icnl9916ac_hd_dsi_vdo.h"
...
#define MIPI_DRIVER_VOLTAGE   0xB
#define ESD_DEFAULT_BACKLIGHT 1638
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xC0, 0x40, 0x93, 0x00, 0x1F);
	jdi_dcs_write_seq_static(ctx, 0xC1, 0x10, 0x20, 0x20, 0x36, 0x04, 0x0C, 0x18, 0x04, 0x44, 0x06, 0x22, 0x70, 0x35, 0x21, 0x07, 0x5F, 0xFF, 0x4C, 0x00, 0x93);
	jdi_dcs_write_seq_static(ctx, 0xC2, 0x01, 0x05, 0x01, 0x10, 0x80, 0x01, 0x00, 0xFF);
	jdi_dcs_write_seq_static(ctx, 0xC3, 0x06, 0x00, 0xFF, 0x00, 0xFF, 0x40, 0x4D, 0x01);
	jdi_dcs_write_seq_static(ctx, 0xC4, 0x04, 0x33, 0xB8, 0x49, 0x00, 0xBC, 0x00, 0xA0, 0x00, 0x09);
	jdi_dcs_write_seq_static(ctx, 0xC5, 0x03, 0x21, 0x96, 0xC8, 0x3E, 0x00, 0x02, 0x02, 0x1E, 0x09, 0x04, 0x18, 0x22, 0x05, 0x00, 0x20, 0x08, 0x1A, 0xC6, 0x03,
	0x64, 0xFF, 0x01, 0x14, 0x38, 0x20);
	jdi_dcs_write_seq_static(ctx, 0xC6, 0xA0, 0x24, 0x13, 0x2B, 0x2B, 0x28, 0x3F, 0x02, 0x16, 0x16, 0x00, 0x01, 0x40, 0x00, 0x98, 0x98, 0x60, 0x80);
	jdi_dcs_write_seq_static(ctx, 0xC8, 0x46, 0x00, 0x48, 0x66);
	jdi_dcs_write_seq_static(ctx, 0xCA, 0x00, 0x40, 0x00, 0x19, 0x46, 0x94, 0x41, 0x8F, 0x33, 0x11, 0x54, 0x68, 0x54, 0x54, 0x5A, 0x6F, 0x5A, 0x5A, 0x33, 0x00,
	0x01, 0x01, 0x0E, 0x09, 0x77, 0x00, 0x05, 0x00, 0x00, 0x5B, 0x5B, 0x04);
	jdi_dcs_write_seq_static(ctx, 0xD4, 0x32);
	jdi_dcs_write_seq_static(ctx, 0xD5, 0x01, 0x72, 0x10);
	jdi_dcs_write_seq_static(ctx, 0xB2, 0x0D, 0x0C, 0x09, 0x08, 0x88, 0x88, 0x09, 0x03, 0x88, 0x47, 0x47, 0x47, 0x47, 0x47, 0x47, 0x47, 0x47, 0x47, 0x47, 0x47,
	0x47, 0x00, 0x00, 0x00, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xB3, 0xF6, 0x09, 0x09, 0x09, 0x81, 0x47, 0x10, 0x10, 0x47, 0x04, 0x04, 0x00, 0x80, 0x80, 0x0C, 0x00, 0x00, 0x30, 0x00, 0x00,
	0x0C, 0x00, 0x00, 0x30, 0x00, 0x00, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55);
	jdi_dcs_write_seq_static(ctx, 0xB4, 0x31, 0x01, 0x01, 0x01, 0x81, 0xB0, 0x00, 0x00, 0xB0, 0x00, 0x00, 0x00, 0x80, 0x44, 0x0C, 0x00, 0x00, 0x30, 0x00, 0x00,
	0x0C, 0x00, 0x00, 0x30, 0x00, 0x00, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55);
	jdi_dcs_write_seq_static(ctx, 0xB5, 0x00, 0x16, 0x0A, 0x16, 0x0A, 0x26, 0x26, 0x01, 0xA2, 0x33, 0x44, 0x00, 0x26, 0x00, 0x59, 0x7C, 0x02, 0x08, 0x30, 0x30,
	0x50, 0x20, 0x40, 0x12);
	jdi_dcs_write_seq_static(ctx, 0xB6, 0x00, 0x00, 0x33, 0x28, 0x2A, 0x0C, 0x0E, 0x10, 0x12, 0x14, 0x16, 0x18, 0x1A, 0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0xFF, 0xFF, 0xFC, 0x20, 0x00, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xB7, 0x00, 0x00, 0x33, 0x29, 0x2B, 0x0D, 0x0F, 0x11, 0x13, 0x15, 0x17, 0x19, 0x1B, 0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0xFF, 0xFF, 0xFC, 0x20, 0x00, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xB8, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55);
	jdi_dcs_write_seq_static(ctx, 0xB9, 0x01, 0x55, 0x55, 0x55, 0x55, 0x55, 0x50, 0x55, 0x55, 0x55, 0x55, 0x55, 0x50, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C,
	0x00, 0x00, 0x00, 0x00, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xBB, 0x01, 0x02, 0x03, 0x0A, 0x04, 0x13, 0x14, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xBC, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0xFF, 0xF0, 0x03, 0x33, 0x50, 0x5B, 0x33, 0x33, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xBD, 0xA1, 0xA2, 0x52, 0x26, 0x00, 0x8F);
	jdi_dcs_write_seq_static(ctx, 0xBE, 0x0C, 0x88, 0x43, 0x38, 0x33, 0x00, 0x00, 0x38, 0x00, 0xB2, 0xAF, 0xB2, 0xAF, 0x00, 0x00, 0x33);
	jdi_dcs_write_seq_static(ctx, 0xBF, 0x0C, 0x19, 0x0C, 0x19, 0x00, 0x11, 0x04, 0x18, 0x50);
	jdi_dcs_write_seq_static(ctx, 0xC7, 0x76, 0x54, 0x32, 0x22, 0x23, 0x45, 0x67, 0x76, 0x20, 0x76, 0x54, 0x32, 0x22, 0x23, 0x45, 0x67, 0x76, 0x20, 0x33, 0x00,
	0x01, 0xFF, 0xFF, 0x40, 0x18, 0x18, 0x43);
	jdi_dcs_write_seq_static(ctx, 0x80, 0xFF, 0xFA, 0xF2, 0xEB, 0xE5, 0xE0, 0xDC, 0xD8, 0xD4, 0xC8, 0xBE, 0xAF, 0xA2, 0x96, 0x8C, 0x83, 0x7A, 0x79, 0x6E, 0x64,
	0x58, 0x4B, 0x3C, 0x2A, 0x21, 0x17, 0x14, 0x11, 0x0E, 0x0B, 0x09, 0x05);
	jdi_dcs_write_seq_static(ctx, 0x81, 0xFF, 0xFA, 0xF2, 0xEB, 0xE5, 0xE0, 0xDC, 0xD8, 0xD4, 0xC8, 0xBE, 0xAF, 0xA2, 0x96, 0x8C, 0x83, 0x7A, 0x79, 0x6E, 0x64,
	0x58, 0x4B, 0x3C, 0x2A, 0x21, 0x17, 0x14, 0x11, 0x0E, 0x0B, 0x09, 0x05);
	jdi_dcs_write_seq_static(ctx, 0x82, 0xFF, 0xFA, 0xF2, 0xEB, 0xE5, 0xE0, 0xDC, 0xD8, 0xD4, 0xC8, 0xBE, 0xAF, 0xA2, 0x96, 0x8C, 0x83, 0x7A, 0x79, 0x6E, 0x64,
	0x58, 0x4B, 0x3C, 0x2A, 0x21, 0x17, 0x14, 0x11, 0x0E, 0x0B, 0x09, 0x05);
	jdi_dcs_write_seq_static(ctx, 0x83, 0x01, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00);
	jdi_dcs_write_seq_static(ctx, 0x84, 0x16, 0xF4, 0x97, 0x2B, 0x1C, 0xA6, 0x00, 0x21, 0xB0, 0x16, 0xF4, 0x97, 0x2B, 0x1C, 0xA6, 0x00, 0x21, 0xB0, 0x16, 0xF4,
	0x97, 0x2B, 0x1C, 0xA6, 0x00, 0x21, 0xB0);
	jdi_dcs_write_seq_static(ctx, 0xFB, 0x54, 0x54);
	jdi_dcs_write_seq_static(ctx, 0xD0, 0x0C, 0x03, 0x18, 0xFF, 0xFF, 0x00, 0x80, 0x0C, 0xFF, 0x0F, 0x40, 0x00, 0x08, 0x04);
	jdi_dcs_write_seq_static(ctx, 0xE0, 0x0C, 0x00, 0xB0, 0x10, 0x00, 0x59, 0x10, 0x00, 0x0B, 0x04, 0x21, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x1E, 0x0F, 0x08, 0x90, 0x48, 0x42, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xE1, 0xD4, 0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x7F, 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF2, 0xFF, 0xFF, 0xFF, 0xFF,
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
	jdi_dcs_write_seq_static(ctx, 0xE2, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF,
	0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF);
	jdi_dcs_write_seq_static(ctx, 0x35, 0x00, 0x00);
	jdi_dcs_write_seq_static(ctx, 0x53, 0x2C, 0x00);
	jdi_dcs_write_seq_static(ctx, 0x55, 0x03, 0x00);
	usleep_range(2000, 2100);
	jdi_dcs_write_seq_static(ctx, 0x11, 0x00, 0x00);
	usleep_range(120000, 120100);
	jdi_dcs_write_seq_static(ctx, 0x29, 0x00, 0x00);
	usleep_range(10000, 10100);
	jdi_dcs_write_seq_static(ctx, 0x6D, 0x02, 0x00);
	jdi_dcs_write_seq_static(ctx, 0xBD, 0xA1, 0xA2, 0x52, 0x2E, 0x00, 0x8F);
...
static void cabc_mode_retore(struct jdi *ctx)
{
	if (cabc_mode_backup == 1) {
		...
		jdi_dcs_write_seq_static(ctx, 0xF1, 0xA5, 0xA6);
		jdi_dcs_write_seq_static(ctx, 0xE1, 0xD4, 0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x7F, 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF2, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFD, 0xFF, 0xFF, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFF, 0xFF);
		jdi_dcs_write_seq_static(ctx, 0xE2, 0x37, 0x5B, 0x3E, 0xB7, 0x3E, 0xB7, 0x3E, 0xB7, 0x3E, 0xB7, 0x3E, 0x1A, 0x3E, 0xB7, 0x3E, 0xB7, 0x3C, 0xC0, 0x3C, 0xC0,
		0x3C, 0xC0, 0x3C, 0xC0, 0x3C, 0xC0, 0x3C, 0xC0, 0x3E, 0xB7, 0x3E, 0xB7);
		jdi_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA6);
		jdi_dcs_write_seq_static(ctx, 0xF1, 0x5A, 0x59);
		...
		jdi_dcs_write_seq_static(ctx, 0xE1, 0xD4, 0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x7F, 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF2, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xFD, 0xFF, 0xFF, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFF, 0xFF);
		jdi_dcs_write_seq_static(ctx, 0xE2, 0x2F, 0xFF, 0x3B, 0x84, 0x3B, 0x84, 0x3B, 0x84, 0x3B, 0x84, 0x3A, 0x14, 0x3B, 0x84, 0x3B, 0x84, 0x39, 0xC0, 0x39, 0xC0,
		0x39, 0xC0, 0x39, 0xC0, 0x39, 0xC0, 0x39, 0xC0, 0x3B, 0x84, 0x3B, 0x84);
		jdi_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA6);
		jdi_dcs_write_seq_static(ctx, 0xF1, 0x5A, 0x59);
		...
		jdi_dcs_write_seq_static(ctx, 0xF1, 0xA5, 0xA6);
		jdi_dcs_write_seq_static(ctx, 0xE1, 0xD4, 0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x7F, 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF2, 0xFF, 0xFF, 0xFF, 0xFF,
		0xFF, 0xF6, 0xF6, 0xF6, 0xF6, 0xF6, 0xF6, 0xFA, 0xFA, 0xFA, 0xFF, 0xFF);
		jdi_dcs_write_seq_static(ctx, 0xE2, 0x1F, 0xFF, 0x39, 0x70, 0x39, 0x70, 0x39, 0x70, 0x39, 0x70, 0x34, 0xB0, 0x34, 0xB0, 0x34, 0xB0, 0x34, 0xD0, 0x34, 0xD0,
		0x34, 0xD0, 0x37, 0x32, 0x37, 0x32, 0x37, 0x32, 0x39, 0x70, 0x39, 0x70);
		jdi_dcs_write_seq_static(ctx, 0xF0, 0xA5, 0xA6);
		jdi_dcs_write_seq_static(ctx, 0xF1, 0x5A, 0x59);
...
static int jdi_unprepare(struct drm_panel *panel)
{
	...
	jdi_dcs_write_seq_static(ctx, 0x6D, 0x25, 0x00);
	jdi_dcs_write_seq_static(ctx, 0x28, 0x00, 0x00);
	usleep_range(10000, 10100);
	jdi_dcs_write_seq_static(ctx, 0x10, 0x00, 0x00);
	usleep_range(105000, 105100);
	/*into deep sleep for reducing power consumption. */
	if (flag_poweroff == 1) {
		if (shutdown_lcd_drv == 1) {
...
#define VAC (1604)
#define HAC (720)
#define VFP_50hz (3036)
#define VFP_60hz (2258)
#define VFP_90hz (958)
#define VFP_120hz (310)
#define DYN_PLL_CLK (599)
#define DYN_DATA_RATE (1198)
#define HFP_DYN (80)
#define PLL_CLOCK (635)
#define DATA_RATE (1270)
...
static struct mtk_panel_params ext_params_50hz = {
                .pll_clk = PLL_CLOCK,
                .vendor = "icnl9916ac_rado",
                .manufacture = "24601_djn_icnl9916ac",
                .cust_esd_check = 0,
                .esd_check_enable = 1,
                .esd_check_eint = 1,
		...
		void *handle)
{
	...
	if (backlight_level_esd == 0)
		backlight_level_esd = ESD_DEFAULT_BACKLIGHT;
...
{
	char bl_tb1[] = {0xF0, 0x5A, 0x59};
	char bl_tb2[] = {0xF1, 0xA5, 0xA6};
	char bl_tb3[] = {0xE1, 0xD4, 0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x7F, 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF2, 0xFF,
	0xFF, 0xFF, 0xFF, 0xFF, 0xFD, 0xFF, 0xFF, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFF, 0xFF};
	char bl_tb4[] = {0xE2, 0x37, 0x5B, 0x3E, 0xB7, 0x3E, 0xB7, 0x3E, 0xB7, 0x3E, 0xB7, 0x3E, 0x1A, 0x3E, 0xB7, 0x3E, 0xB7, 0x3C,
	0xC0, 0x3C, 0xC0, 0x3C, 0xC0, 0x3C, 0xC0, 0x3C, 0xC0, 0x3C, 0xC0, 0x3E, 0xB7, 0x3E, 0xB7};
	char bl_tb5[] = {0xE1, 0xD4, 0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x7F, 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF2, 0xFF,
	0xFF, 0xFF, 0xFF, 0xFF, 0xFD, 0xFF, 0xFF, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFF, 0xFF};
	char bl_tb6[] = {0xE2, 0x2F, 0xFF, 0x3B, 0x84, 0x3B, 0x84, 0x3B, 0x84, 0x3B, 0x84, 0x3A, 0x14, 0x3B, 0x84, 0x3B, 0x84, 0x39,
	0xC0, 0x39, 0xC0, 0x39, 0xC0, 0x39, 0xC0, 0x39, 0xC0, 0x39, 0xC0, 0x3B, 0x84, 0x3B, 0x84};
	char bl_tb7[] = {0xE1, 0xD4, 0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x7F, 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF2, 0xFF,
	0xFF, 0xFF, 0xFF, 0xFF, 0xF6, 0xF6, 0xF6, 0xF6, 0xF6, 0xF6, 0xFA, 0xFA, 0xFA, 0xFF, 0xFF};
	char bl_tb8[] = {0xE2, 0x1F, 0xFF, 0x39, 0x70, 0x39, 0x70, 0x39, 0x70, 0x39, 0x70, 0x34, 0xB0, 0x34, 0xB0, 0x34, 0xB0, 0x34,
	0xD0, 0x34, 0xD0, 0x34, 0xD0, 0x37, 0x32, 0x37, 0x32, 0x37, 0x32, 0x39, 0x70, 0x39, 0x70};
	char bl_tb9[] = {0xE1, 0xD4, 0x0F, 0x1F, 0x2F, 0x3F, 0x4F, 0x5F, 0x6F, 0x7F, 0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF2, 0xFF,
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
	char bl_tb10[] = {0xE2, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F,
	0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF, 0x3F, 0xFF};
	char bl_tb11[] = {0xF1, 0x5A, 0x59};
	char bl_tb12[] = {0xF0, 0xA5, 0xA6};
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
        ...
        pr_info("%s+ jdi_probe enter djn,icnl9916ac,vdo,120hz\n", __func__);
	...
	register_device_proc("lcd", "icnl9916ac_rado", "24601_djn_icnl9916ac");
...
static const struct of_device_id jdi_of_match[] = {
        {
                .compatible = "oplus24601,djn,icnl9916ac,hd,dsi,vdo",
        },
        {
        }
};
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "oplus24601_djn_icnl9916ac_hd_dsi_vdo",
                .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("DJN ICNL9916AC VDO 120HZ LCD Panel Driver");
