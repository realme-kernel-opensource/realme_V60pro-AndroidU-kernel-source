 ...
 ** OPLUS_EDIT
 ** File: oplus24605_ds_ili7807s_fhd_dsi_vdo.h
...
#endif
#include "oplus24605_ds_ili7807s_fhd_dsi_vdo.h"
...
#define MAX_NORMAL_BRIGHTNESS   3435
...
static void jdi_panel_init(struct jdi *ctx)
{
        ...
        jdi_dcs_write_seq_static(ctx, 0xF8, 0x2C);
        jdi_dcs_write_seq_static(ctx, 0xF9, 0x03);
        jdi_dcs_write_seq_static(ctx, 0xFA, 0x00);
        /*cabc start
        cabc MODE1*/
        ...
        jdi_dcs_write_seq_static(ctx, 0xB3, 0xFE);
        ...
        jdi_dcs_write_seq_static(ctx, 0x92, 0xC6);
        jdi_dcs_write_seq_static(ctx, 0x93, 0xC7);
        jdi_dcs_write_seq_static(ctx, 0x94, 0xCA);
        jdi_dcs_write_seq_static(ctx, 0x95, 0xDD);
        jdi_dcs_write_seq_static(ctx, 0xB4, 0xFE);
        /*cabc MODE3*/
        jdi_dcs_write_seq_static(ctx, 0xA8, 0xF4);
        jdi_dcs_write_seq_static(ctx, 0xAB, 0xD0);
        jdi_dcs_write_seq_static(ctx, 0xAE, 0xF4);
        ...
        jdi_dcs_write_seq_static(ctx, 0x9C, 0xBD);
        jdi_dcs_write_seq_static(ctx, 0x9D, 0xC6);
        jdi_dcs_write_seq_static(ctx, 0x9E, 0xC6);
        jdi_dcs_write_seq_static(ctx, 0x9F, 0xDF);
        jdi_dcs_write_seq_static(ctx, 0xB5, 0xFE);
	...
	jdi_dcs_write_seq_static(ctx, 0xFF, 0x78, 0x07, 0x00);
        ...
        jdi_dcs_write_seq_static(ctx, 0x68, 0x02, 0x00);
...
#define VAC (2400)
#define HAC (1080)
#define VFP_45hz (4150)
#define VFP_48hz (3740)
#define VFP_50hz (3500)
#define VFP_60hz (2520)
#define VFP_90hz (868)
#define VFP_120hz (40)
#define PLL_CLOCK (366)
#define DATA_RATE (732)
...
static struct mtk_panel_params ext_params_45hz = {
                .vendor = "ili7807s_barley",
                .manufacture = "24605_ds_ili7807s",
                .pll_clk = PLL_CLOCK,
                .cust_esd_check = 1,
                .esd_check_enable = 1,
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
        ...
        pr_info("%s+ jdi_probe enter ds,ili7807s,vdo,120hz,6382\n", __func__);
	...
	register_device_proc("lcd", "ili7807s_barley", "24605_ds_ili7807s");
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "oplus24605_ds_ili7807s_fhd_dsi_vdo",
                .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("JDI ILI7807S VDO 120HZ LCD Panel Driver");
